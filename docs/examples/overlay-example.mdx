...
import { OverlayDetailedExample } from "@site/src/components/examples/overlayDetailedExample";
import { OverlayComponentExample } from "@site/src/components/examples/overlayComponentExample";
import { OverlayMultipleExample } from "@site/src/components/examples/overlayMultipleExample";
...
<BrowserOnly>{() => <OverlayDetailedExample />}</BrowserOnly>
...
<BrowserOnly>{() => <OverlayComponentExample />}</BrowserOnly>
...
<BrowserOnly>{() => <OverlayMultipleExample />}</BrowserOnly>
